...
export default function EducationalMobileApps({ pagedata }) {
    ...
    console.log("Single Obj", pagedata);
    ...
    const handleSearch = () => {
        ...
        axios
            ...
            .then((rec) => {
                ...
                // setSearch("")
                if (!rec.data.data) {
                    toast.error("No Data Fount Related to Search!")
                }
    ...
    return (
        <>
            <Head>
                <title>Best Educational Apps for Students, Teachers & Parents</title>
                <meta name="description" content="Educational apps help you learn something new or expand your knowledge of a topic without physically attending classes. Find the list of best apps here!" />
            </Head>
                ...
                <div className="containerrow">
                    ...
                    <div className="searchBox">
                                    ...
                                    return (
                                        <div key={index}>
                                            <input
                                                ...
                                                type="checkbox"
                                                htmlhtmlFor={postlist.category}
                                            />
                                            <Link href={postlist.category_slug}>
                                                <label id={postlist.category} className="anchorTag">{postlist.category}</label>
                                            </Link>
                                        </div>
                                    );
                                })}
                        ...
                        <div className="categories">
                            <h5 className="formLable">Categories</h5>
                            <div className="categoriesSpace">
                                {categoriesData.catdata?.filter(filtration => filtration.category_slug !== 'teacher-app' && filtration.category_slug !== 'apps-for-parents' && filtration.category_slug !== 'apps-for-students' && filtration.category_slug !== 'critical-thinking-apps' && filtration.category_slug !== 'typing-app').map((postlist, index) => {
                                    if (duplicateCheck.includes(postlist.category)) return null;
                                    duplicateCheck.push(postlist.category);
                                    return (
                                        <div key={postlist.category_slug} className='new-radiobtnlink'>
