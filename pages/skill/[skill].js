...
export const skillspaths = [
    ...
    {
        "id": 2,
        "skillName": "Cognitive Development",
        "slug": "cognitive-development"
    },
    {
        "id": 3,
        "skillName": "Thinking & Reasoning",
        "slug": "thinking-reasoning"
    },
    {
        "id": 4,
        "skillName": "Creative Development",
...
export default function InnerSkillPage({ pagedata, allcategoriesdata }) {
    ...
    const withoutSearch = pagedata && pagedata.data.map(carddata => {
        return (
                            ...
                            <div className="headingSec">
                                ...
                                <div className="tittleButton">
                                    <label className="labelForm">
                                        {skillspaths.map((skilltitle) => (
                                            <span key={skilltitle.id}>
                                                {router.asPath == `/skill/${skilltitle.slug}/` && `${skilltitle.skillName}`}
                                            </span>
                                        ))}
                                    </label>
                                </div>
                                ...
                                <div className="headingSec">
                                    <div>
                                        <p className="musicPara">
                                            Showing results for {pagedata.datalength} apps
                                        </p>
                                    </div>
                                </div>
                            </div>
