...
export default function EdTechAppsInDetails2({edtechappsdata}) {
                        ...
                        <div className="sidebar-inner">
                            <div className="">
                                ...
                                <div className="sidebar-recent-blog side-list mt-4">
                                    <h3>Recent Blogs</h3>
                                    <EdTechRecentBlogs appdatalist='digital-content' />
                                </div>
...
export async function getServerSideProps() {
    try {
      const edtechappsdatares = await fetch('https://admin.educationalmobileapps.com/edtechappcategories?category_slug=digital-content')
