...
export default function EdTechAppsInDetails1({edtechappsdata}) {
                    ...
                    <div className="mainContent mt-3">
                        <div className="tab-content" id="myTabContent">
                            <div className="tab-pane show active" id="cat1-tab-pane" role="tabpanel" aria-labelledby="cat1-tab" tabIndex="0">
                                ...
                                <EdTechIntroData appdatalist='mooc' />
                                <div className="row mainRowCards">
                                    <EdtechAppsList appdatalist='mooc' />
                                </div>
                                <div className="my-5"></div>
                                <EdTechIntroData appdatalist='lms' />
                                <div className="row mainRowCards">
                                    <EdtechAppsList appdatalist='lms' />
                                </div>
                            </div>
                        </div>
                    </div>
