...
export default function EdTechAppsInDetails5({edtechappsdata}) {
                        ...
                        <div className="sidebar-inner">
                            <div className="">
                                ...
                                <div className="sidebar-recent-blog side-list mt-4">
                                    <h3>Recent Blogs</h3>
                                    <EdTechRecentBlogs appdatalist='workforce-and-skills' />
                                </div>
...
export async function getStaticProps() {
    const edtechappsdatares = await fetch('https://admin.educationalmobileapps.com/edtechappcategories?category_slug=workforce-and-skills')
