...
export default function InnerSinglePage({ pagedata, allcategoriesdata, rightsidedata }) {
    ...
    // Handle sidebarfilterfunction
    function sidebarfilterfunction() {
        document.querySelector('.searchBox').classList.toggle('searchBox-showinmobile');
    }

    if (pagedata.categoriesData.length > 0) {
        return (
            <>
                <Head>
                        ...
                        <div className="searchBox">
                            ...
                            <div className="categories">
                                ...
                                <div className="categoriesSpace">
                                    {allcategoriesdata?.filter(filtration => filtration.category_slug !== 'teacher-app' && filtration.category_slug !== 'apps-for-parents' && filtration.category_slug !== 'apps-for-students' && filtration.category_slug !== 'critical-thinking-apps' && filtration.category_slug !== 'typing-app').map((postlist, index) => {
                            ...
                            {/* User */}
                            <h5 className="formLable">User</h5>
                            <div className="categoriesSpace user-categoriesSpace">
                                <div className={router.asPath == `/user/apps-for-students/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='userLink1'>
                                        <input type="radio" name="categorynamelink" id='userLink1' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Student`); router.push(`/user/apps-for-students/`)}} required />
                                        <span>Student</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/user/apps-for-teacher/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='userLink2'>
                                        <input type="radio" name="categorynamelink" id='userLink2' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Teacher`); router.push(`/user/apps-for-teacher/`)}} required />
                                        <span>Teacher</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/user/students-with-special-needs/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='userLink3'>
                                        <input type="radio" name="categorynamelink" id='userLink3' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`students-with-special-needs`); router.push(`/user/students-with-special-needs`)}} required />
                                        <span>Students with Special Needs</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/user/apps-for-parents/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='userLink4'>
                                        <input type="radio" name="categorynamelink" id='userLink4' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Parent`); router.push(`/user/apps-for-parents/`)}} required />
                                        <span>Parent</span>
                                    </label>
                                </div>
                            </div>
                            ...
                            {/* skill */}
                            <h5 className="formLable">Skill</h5>
                            <div className="categoriesSpace user-categoriesSpace">
                                <div className={router.asPath == `/skill/communication-skills/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='skillLink1'>
                                        <input type="radio" name="categorynamelink" id='skillLink1' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Communication`); router.push(`/skill/communication-skills`)}} required />
                                        <span>Communication</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/skill/cognitive-development/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='skillLink2'>
                                        <input type="radio" name="categorynamelink" id='skillLink2' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Cognitive Development`); router.push(`/skill/cognitive-development`)}} required />
                                        <span>Cognitive Development</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/skill/thinking-reasoning/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='skillLink3'>
                                        <input type="radio" name="categorynamelink" id='skillLink3' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Thinking & Reasoning`); router.push(`/skill/thinking-reasoning`)}} required />
                                        <span>Thinking & Reasoning</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/skill/creative-development/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='skillLink4'>
                                        <input type="radio" name="categorynamelink" id='skillLink4' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Creative Development`); router.push(`/skill/creative-development`)}} required />
                                        <span>Creative Development</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/skill/tech-skills/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='skillLink5'>
                                        <input type="radio" name="categorynamelink" id='skillLink5' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Tech Skills`); router.push(`/skill/tech-skills`)}} required />
                                        <span>Tech Skills</span>
                                    </label>
                                </div>
                                <div className={router.asPath == `/skill/critical-thinking/` ? 'new-radiobtnlink new-radiobtnlink-active' : 'new-radiobtnlink'}>
                                    <label htmlFor='skillLink6'>
                                        <input type="radio" name="categorynamelink" id='skillLink6' onChange={(e) => { setcategorylinkfield(e.target.checked); setcategoryvalueTrue(`Critical Thinking`); router.push(`/skill/critical-thinking`)}} required />
                                    ...
                                    <div className="headingSec">
                                        <div>
                                            <p className="musicPara">
                                                Showing results for {pagedata.apps} apps
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div id="filterSearch">
                                                ...
                                                <div className="userList">
                                                    ...
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault11">
                                                            Student
                                                        </label>
                                                    </div>
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault22">
                                                    ...
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault33">
                                                            Parents
                                                        </label>
                                                    </div>
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault44">
                                                            Teacher
                                                        </label>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="userList">
                                                    ...
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault1">
                                                    ...
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault2">
                                                    ...
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault3">
                                                            Thinking & Reasoning
                                                        </label>
                                                    </div>
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault4">
                                                    ...
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault5">
                                                            Tech Skills
                                                        </label>
                                                    </div>
                                                    <div className="userSelect">
                                                        ...
                                                        />
                                                        <label className="anchorTag " htmlFor="flexCheckDefault6">
                                                            Critical Thinking
                                                        </label>
                                                    </div>
                                                </div>
                        ...
                        <div className="editorsPick">
                            <div className="editorscol">
                                <div className="editorsCard">
                                    ...
                                    {rightsidedata &&
                                        rightsidedata.editorsPickDataData.length > 0 &&
                                        rightsidedata.editorsPickDataData.map(
                                            (educationcardresdata, index) => {
                                                return (
                                                    <div className="card" key={educationcardresdata.app_name}>
                                ...
                                <div className="editorsCard">
                                    ...
                                    <div className="card">
                                        <div className="card-body subsiPadding">
                                            {rightsidedata &&
                                                rightsidedata.newAdditionsData.length &&
                                                rightsidedata.newAdditionsData.map(
                                                    (educationcardresdata, index) => {
                                                        return (
                                                            <div className="additionsDiv" key={educationcardresdata.app_name}>
                            ...
                            <div className="editorscol editMainCard">
                                <div className="editorsCard">
                                    ...
                                    <div className="card">
                                        <div className="card-body subsiPadding">
                                            {rightsidedata &&
                                                rightsidedata.popularAppsData.length &&
                                                rightsidedata.popularAppsData.map(
                                                    (educationcardresdata, index) => {
                                                        return (
                                                            <div className="additionsDiv" key={educationcardresdata.app_name}>
                                                                <div className="additionImg">
                ...
                {/* <div style={{marginTop: `200px`}}>
                  {pagedata.map((categoriesdata) => (
                    (
                        <div style={{marginBottom: `30px`}} className='catblock' key={categoriesdata.id}>
                            <h3>{categoriesdata.app_name}</h3>
                            <p>{categoriesdata.description}</p>
                        </div>
                    )
                  ))}
                </div> */}
...
export async function getStaticPaths() {
    // const paths = catdatalist.map((slugname) => ({
...
export async function getStaticProps({ params }) {
    // const pagedata = catdatalist.filter(p => p.category_slug.toString() == params.slug);
    const allcategoriesdata = catdatalist

    const pagedatares = await fetch(`https://admin.educationalmobileapps.com/educationappcategories?category_slug=${params.slug}`);
    const pagedata = await pagedatares.json()
    
    // const res = await fetch(`https://admin.educationalmobileapps.com/educationappcategories?category_slug=${params.slug}`);
    // const slugdata = catdatalist.category_slug == params.slug;
    // const pagedata = await res.json();
    // console.log("Catdata Data", pagedata);

    // right sidebar fetching data
    const rightsideres = await fetch(`https://admin.educationalmobileapps.com/educationappcategories?category_slug=${params.slug}`);
